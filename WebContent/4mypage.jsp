		                    ...
		                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
		                            ...
		                            <li class="nav-item dropdown me-3">
		                                ...
		                                <ul class="dropdown-menu dropdown-menu-end">
		                                    <l ><a class="dropdown-item " href="mypage.action">마이페이지</a></li>
		                                    <li><a class="dropdown-item " href="#">정보 수정</a></li>
		                      col-lg-3      <li><hr></li>
		                                    <li><a class="dropdown-item " href="logoutAction.action">로그아웃</a></li>
		                                </ul>
		                            </li>
		   col-lg-3 col-lg-9        <li class="nav-item me-3">
								        	<div class="third"><a class="text-center btn1 btn-primary btn-block">강사 등록</a></div>bsp;&nbsp;</a></li>
		                        </ul>
		                    </div>
		                </div>
		            </nav>
            ...
            <header class="bg-dark py-5" style="background-image: URL(images/guitar2.png); height: 820px;">
             ...
             col-lg-3               <a class="btn btn-outline-light btn-lg px-4 me-sm-3" href="#muhobby">MUHOBBY 시작하기</a>
                                </div>
                            </div>
                        </div>
