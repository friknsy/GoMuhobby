                            ...
                            <div class="col-xl-10 col-md-8">
                                ...
                                <div style="width:100%">
									<div class="first ms-4 text-start">
	                               		<h4 style="width:100%">내가 신청한 클래스</h4>
	                                </div>
                                ...
                                <div class="shadow col-md-11 card bg-light text-gray mt-4 ms-7">
                                    <div class="parent">
								        <div class="first sb-sidenav-menu-heading h4 mt-3" style="width:30%">
								        	<img class="img-fluid rounded mb-5 mb-lg-0" src="images/piano2.jpg" style="width: 320px; height: 200px;"/>
								        	<h5 class="mt-3"> 🎹 클래식 피아노 A to Z 🎹 </h5>
								        </div>
								        <div class="second sb-sidenav-menu-heading fs-5 mt-3 bold" style="width:60%; height: 100%">
								        	...
								        	노희주캔슬링 님의 클래스 🥇 <br><br>
 											...
 											<div class="third d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start text-end" style="width:50%">
									        	<a class="btn btn-outline-light2 btn-sm1">상세정보</a>
									        	<a class="btn btn-outline-light2 btn-sm1">후기 작성</a>
									        	<a class="btn btn-outline-light2 btn-sm1">수강 취소</a>
 											</div>
 											<div class="h6 bold" style="width:100%" >2021.06.13(일) 17:00 ~ 20:00</div>
 											<div class="h6 bold mt-4" style="width:100%" >클래스 상태 : 수강 완료</div>
								        </div>
								    </div>
                                </div>
                                    ...
                                    <div class="parent">
								        ...
								        <div class="second sb-sidenav-menu-heading fs-5 mt-3 bold" style="width:60%; height: 100%">
								        	...
								        	X - JAUNGJUN 님의 클래스 🥇 <br><br>
 											...
 											<div class="h6 bold" style="width:100%" >2021.06.15(화) 17:00 ~ 20:00</div>
 											<div class="h6 bold mt-4" style="width:100%" >클래스 상태 : 수강 완료</div>
								        </div>
								    </div>
                                </div>
