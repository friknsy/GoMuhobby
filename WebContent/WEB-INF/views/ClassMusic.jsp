...
<script type="text/javascript">
	...
	$(function()
	{
		...
		{
			$("#none").html("<br><br><b>아직 회원님이 관심 음악을 등록하지 않으셨거나 선택하신 관심 음악 클래스가 아직 개설되지 않았어요😭 " + 
					        "<br>관심 음악은 회원 정보 수정에서 등록가능합니다. 지금 등록하러 가볼까요?<b>");
		}
	});
...
<div class="container" style="text-align: center">
	...
	<div>
		<div>
			...
			<div style="float: left; margin-top: 5px;"><p>&nbsp;&nbsp;회원님이 등록하신 관심음악 클래스입니다!</p></div>
