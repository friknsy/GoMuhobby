...
<head>
<meta charset="UTF-8">
<title>QA_forumUpdateForm.jsp</title>
<!-- Favicon-->
...
<div class="container">
	<form action="qa_forumupdate.action?qa_forum_code=${qread.qa_forum_code}" method="post">
		<table class="table table-bordered"> <!-- 테이블 가운데 정렬하고싶은데 왜 안되누..ㅠ -->
			<tr>
				<th>제목</th>
				<td class="title-left">
					<input type="text" style="width: 700px;"
					id="qa_forum_title" name="qa_forum_title"
					value="${qread.qa_forum_title }">
				</td>
			</tr>	
			<tr>
				<th colspan="2">내용</th>
			...
			<tr>
				<td colspan="2">
					...
					id="qa_forum_content" name="qa_forum_content">${qread.qa_forum_content }</textarea>
				</td>
			</tr>	
		</table>
		
		<div style="text-align: center">
			<button type="submit" class="btn bbtn-outline-light btn-sm1">수정하기</button>
			&nbsp;&nbsp;
