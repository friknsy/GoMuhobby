...
<head>
<meta charset="UTF-8">
<title>QnaBoard_InsertForm.jsp</title>
<!-- Favicon-->
...
<div class="container">
	<form action="qnaboardinsert.action" method="post">
		<table class="table table-bordered"> <!-- 테이블 가운데 정렬하고싶은데 왜 안되누..ㅠ -->
			<tr>
				...
				<td>
					<select id="qna_cat_code" name="qna_cat_code">
						...
						<option value="4">서비스 이용문의</option> -->
			...
			<tr>
				<td colspan="2">
					...
					id="qna_content" name="qna_content" required="required"></textarea>
				</td>
			</tr>	
		</table>
		...
		<div style="text-align: center">
			...
			onclick="location.href='qnaboard.action'">뒤로가기</button>
