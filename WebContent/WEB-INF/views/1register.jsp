    ...
    <head>
        ...
        <script type="text/javascript">
        	...
        	function registerCheckFunction()
        	{
        		...
        		// alert(userId); 정상적으로 잘 받아옴.
        		
        		$.ajax
        		({
        		    type : "POST"
        		  , url : "/idCheck.do"
        		  ,	data : { userId : userId }	// 키와 값
        		  , dataType: "json"
                                        ...
                                        <br>
                                            ...
                                            <span class="mb-2 fw-bold">아이디</span>
                                                ...
                                                <div class="col-md-3 d-grid mb-2">
                                                	<button type="button" class="text-center btn1 btn-primary btn-block" onclick="registerCheckFunction();">중복 검사</button>
                                                </div>
                                                <div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <select class="form-select" aria-label="Default select example" name="h_area1" onChange="cat1_change(this.value,h_area2)">
														<option>-선택-</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-select" aria-label="Default select example" name="h_area2">
										            	<option>-선택-</option>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="d-grid gap-3 d-sm-flex btn-group mb-2" data-toggle="buttons">
                                                	<label class="btn btn-primary">
                                                		<input type="checkbox" name="hobby" autocomplete="off" value="피아노/건반"> 피아노/건반
                                                	</label>
                                                	<label class="btn btn-primary">
